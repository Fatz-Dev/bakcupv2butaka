<template>
  <div :class="{ 'sidebar-mini': sidebarCollapsed }">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all"
      :class="{ 'sidebar-mini': sidebarCollapsed }">
          ...
          <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
              <router-link class="nav-link" :class="{
                active: $route.path === '/dashboard/resepsionis',
              }" to="/dashboard/resepsionis">
              ...
              <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p>
                      Selamat datang di dashboard admin BuTaKa | Monitoring Buku
                      Tamu Kantor.
                    </p>
                  </div>
                </div>
      ...
      <footer class="footer">
        <div class="footer-body">
          ...
          <div class="right-panel">
            ©
            {{ new Date().getFullYear() }} BuTaKa, Made with
            <span class="">
...
const resepsionisMenuExpanded = ref(
  route.path.startsWith("/dashboard/resepsionis")
);
const tamuMenuExpanded = ref(route.path.startsWith("/dashboard/tamu"));

// Toggle functions
const toggleResepsionisMenu = () => {
  resepsionisMenuExpanded.value = !resepsionisMenuExpanded.value;
};
const toggleTamuMenu = () => {
  tamuMenuExpanded.value = !tamuMenuExpanded.value;
};
...
watch(
  () => route.path,
  (newPath) => {
    if (newPath.startsWith("/dashboard/resepsionis"))
      resepsionisMenuExpanded.value = true;
    if (newPath.startsWith("/dashboard/tamu")) tamuMenuExpanded.value = true;
  }
);
...
const isResepsionisOpen = computed(() =>
  route.path.startsWith("/dashboard/resepsionis")
);
...
const CSS_FILES = [
  {
    id: "datatables-cdn",
    href: "https://cdn.datatables.net/v/dt/dt-2.3.6/datatables.min.css",
  },
  { id: "hope-ui-core", href: "/assets/css/core/libs.min.css" },
  { id: "aos-css", href: "/assets/vendor/aos/dist/aos.css" },
...
const JS_FILES = [
  ...
  { id: "widgetcharts-js", src: "/assets/js/charts/widgetcharts.js" },
  { id: "vectore-chart-js", src: "/assets/js/charts/vectore-chart.js" },
  { id: "dashboard-chart-js", src: "/assets/js/charts/dashboard.js" },
  { id: "fslightbox-js", src: "/assets/js/plugins/fslightbox.js" },
  { id: "setting-js", src: "/assets/js/plugins/setting.js" },
  { id: "slider-tabs-js", src: "/assets/js/plugins/slider-tabs.js" },
  { id: "form-wizard-js", src: "/assets/js/plugins/form-wizard.js" },
  { id: "aos-js", src: "/assets/vendor/aos/dist/aos.js" },
  { id: "hope-ui-main-js", src: "/assets/js/hope-ui.js" },
];

// Load Hope UI Styles and Scripts
const loadHopeUI = () => {
